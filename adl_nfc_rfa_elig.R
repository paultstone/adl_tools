...
# take a subset
adl_nfc_rosters_sub <- select(adl_nfc_rosters, "franchise_name", "player_name", "pos", "age", "salary", "contract_years", "signed_year", "contract_type")

# add erfa eligibility
adl_nfc_rosters_sub$erfa <- with(adl_nfc_rosters_sub, 
...
adl_nfc_rosters_sub$rfa <- 
  with(adl_nfc_rosters_sub,
